...
class InfoStudent extends Component {
  ...
  componentDidMount() {
    ...
    if (match) {
      ...
      var idScore = sessionStorage.getItem("msv");
      ...
      <div className="container">
        ...
        <Site>
          ...
          <Gpa_site>
            ...
            <p style={{ marginTop: "0px" }}>Điểm trung bình học kỳ:</p>
            <label>{tbhk}</label>
            <p style={{ marginTop: "0px" }}>Điểm trung bình tích lũy:</p>
            <label>{gpa}</label>
            <p style={{ marginTop: "0px" }}>Điểm rèn luyện :</p>
            <label>{drl}</label>
            <p>
              Trạng thái:&nbsp;
              <label
