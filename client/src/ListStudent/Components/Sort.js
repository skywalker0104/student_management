        ...
        <tr>
          ...
          <th className="text_center">
            <div className="dropdown">
              <button
                ...
                aria-expanded="true"
              >
                ĐRL &nbsp; <span className="fa fa-caret-square-o-down"></span>
              </button>
              <ul className="dropdown-menu" aria-labelledby="dropdownMark">
                <li onClick={() => this.onSort("drl", -1)}>
                  <a
                    role="button"
                    className={
                      this.state.sortby === "drl" && this.state.sortvalue === -1
                        ? "sort_selected"
                        : ""
                    }
                  >
          ...
          <th className="text_center">
            <div className="dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="dropdownMark">
                <li onClick={() => this.onSort("tbhk", -1)}>
                  <a
                    role="button"
                    className={
                      this.state.sortby === "tbhk" &&
                      this.state.sortvalue === -1
                        ? "sort_selected"
                        : ""
                    }
                ...
                <li onClick={() => this.onSort("tbhk", 1)}>
                  <a
                    role="button"
                    className={
                      this.state.sortby === "tbhk" && this.state.sortvalue === 1
                        ? "sort_selected"
                        : ""
                    }
                  >
          ...
          <th className="text_center">
            <div className="dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="dropdownMark">
                <li onClick={() => this.onSort("gpa", -1)}>
                  <a
                    role="button"
                    className={
                      this.state.sortby === "gpa" && this.state.sortvalue === -1
                        ? "sort_selected"
                        : ""
                    }
                  >
